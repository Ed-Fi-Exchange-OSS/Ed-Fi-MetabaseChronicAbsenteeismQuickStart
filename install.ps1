...
$packageUrl = "https://github.com/Ed-Fi-Exchange-OSS/Ed-Fi-MetabaseChronicAbsenteeismQuickStart/archive/main.zip"
...
# 3) Execute script
$pathToMainScript = "$global:pathToWorkingDir\Ed-Fi-MetabaseChronicAbsenteeismQuickStart-main\binaryInstall.ps1"
